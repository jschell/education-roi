...
- pinned final revised EF2022D data/dictionary pair with separately validated legacy
  lowercase workbook sheet, 2021 entry cohort semantics, and exact-UNITID lookup;
  live official source registration and UW observation verified.
...
3. Add aid, enrollment, other completion cohorts, and program production. Extend retention beyond
   the pinned EF2023D observation to an earlier analytical table and cross-release comparison. Expense
